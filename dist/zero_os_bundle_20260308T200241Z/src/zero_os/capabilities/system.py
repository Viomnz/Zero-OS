...
class SystemCapability:
    ...
    def run(self, task: Task) -> Result:
        ...
        if text.strip() in {"zero os native ui", "zero os native ui launch", "native zero ui", "launch zero os native ui"}:
            return Result(self.name, json.dumps(native_zero_ui_launch(task.cwd), indent=2))

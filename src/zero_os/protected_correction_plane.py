        ...
        protected_targets=frozenset(
            {
                ...
                "immune_beacon_policy",
                "immune_beacon_issuer_policy",
                "immune_beacon_scope_certification_policy",
                "immune_beacon_revocation_policy",
                "decoy_beacon_policy",
                "decoy_beacon_inventory",
                "decoy_beacon_response_policy",
                "decoy_beacon_instrumentation_policy",
                "decoy_event_provenance_policy",
                ...
                "protected_data_sink_mediation_policy",
                "protected_export_actuator_policy",
                ...
                "protected_data_os_isolation_policy",
                "protected_data_broker_service_policy",
                "protected_data_tpm_seal_policy",
                "protected_data_monotonic_unseal_policy",
                "zero_os_source",
                "firmware_policy",

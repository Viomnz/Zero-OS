...
def execute_zero_engine_plane(
    ...
    *,
    ...
    report = {
        ...
        "decisions": decisions,
        "authority": dict(decision_block.get("authority") or {}),
        ...
        "mutation_budget": {
            ...
            "blocked_mutation_count": int(execution.get("blocked_mutation_count", 0)),
            "authorized_candidate_count": int(execution.get("authorized_mutating_candidate_count", 0)),
        },
        "scan_mode": "parallel",
        "executor": "universal",
